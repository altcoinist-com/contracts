...
contract PaymentCollectorV2 is Ownable2Step {
    ...
    mapping (address => mapping (address => uint256)) lastRenewal;
    constructor (
        address _owner,
        address  _altt,
        address _registry
    ...
    function _pull(address subber, address author) internal {
        ...
        require(lastRenewal[subber][author] < block.timestamp - 29 days, "CD");
        pullLocked = true;
        ...
        lastRenewal[subber][author] = block.timestamp;
        pullLocked = false;
    }
